function(Type, PatchName)
    ...
    -- // Vars
    local PatchFormat = "https://raw.githubusercontent.com/CybrCyko/Aiming/main/GamePatches/%s/%s.lua"
    ...
    if (not Success) then
        local ModuleFormat = "https://raw.githubusercontent.com/CybrCyko/Aiming/main/%s.lua"
