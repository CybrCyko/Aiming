return function(Type, PatchName)
    ...
    -- // Vars
    local PatchFormat = "https://raw.githubusercontent.com/CybrCyko/Aiming/GamePatches/%s/%s.lua"
    ...
    if (not Success) then
        local ModuleFormat = "https://raw.githubusercontent.com/CybrCyko/Aiming/%s.lua"
